...
//remove white spaces
var emailU = emailUser.replace(/\s/g, '').replace("\n", " ");
        ...
        function (dataClipsServerDBReply, status) {
            ...
            $.each(dataClipsServerDBReply, function (index, value) {
                ...
                for (m in value) {
                    ...
                    //if it is a urlresource, then change to iframe format
                    ...
                    //var btnAddVideoToMyClips = '<button type="button" class="btn btn-primary" data-dismiss="modal"   onclick="inviteSubscribe(' + videoId + ')">Add to My Clips</button>  ';
                     ...
                     //AddClipFromYouTube
                    //var AddClipFromYouTube="AddClipFromYouTube";
                        
                    //var btnAddVideoToMyClips = '<button type="button" class="btn btn-primary" data-target="#' + AddClipFromYouTube + '" data-dismiss="modal"   >Add to My Clips</button>  ';
                    ...
                    //var btnAddMyRatingVideo='<button style="margin-right: 5px;" type="button" class="btn btn-danger btn-sm glyphicon glyphicon-star-empty" data-toggle="modal" data-target='+inviteNoMemberRating()+' >Rate Video </button>';  

                    //var btnAddMyRatingVideo='<button style="margin-right: 5px;" type="button" class="btn btn-danger btn-sm glyphicon glyphicon-star-empty" data-toggle="modal" data-target='+inviteNoMemberRating()+' onclick="inviteSubscribe(' + videoId + ')">Rate Video </button>';  
...
//fn invite to subscribe if a non member wants to rate a video
